...
// glam's `scalar-math` implementation intentionally omits serde for the aligned boolean masks.
// The rest of their opaque reflection support remains valid in this scalar-only build.
impl_reflect_opaque!(::glam::BVec3A(Clone, Debug, Default));
impl_reflect_opaque!(::glam::BVec4A(Clone, Debug, Default));
