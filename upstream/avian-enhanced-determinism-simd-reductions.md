...
- Local fix SHIPPED: workspace-wide `glam/scalar-math`, the direct glam dependency unified on
  0.32.1, and a vendored bevy_reflect 0.19.0 compatibility patch that omits serde registrations
  for scalar glam's unsupported `BVec3A`/`BVec4A` serde types.
