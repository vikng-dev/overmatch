...
| Contact-restore fix (slice 3, in flight) | lightyear_avian rollback restore path / avian #734 — contact state not restored, first replayed tick free-falls | Upstream contact-graph restore that re-forms contacts at k=1 |
