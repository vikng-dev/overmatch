...
- `GLOSSARY.md` and `CONTEXT-MAP.md` at the repo root
...
- **Multi-context** — `CONTEXT-MAP.md` at the root pointing to per-context `GLOSSARY.md` files (typically a monorepo).
