...
fn apply_settings(
    ...
    hidden_capture: Option<Res<crate::net::HiddenCaptureWindow>>,
) {
...
///
/// NOT gated on [`crate::net::HiddenCaptureWindow`], deliberately, unlike [`apply_settings`]'s
