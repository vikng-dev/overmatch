...
pub struct ViewConfig {
    /// Vertical field of view (RADIANS), taken from the authored [`crate::spec::Optics`] at spawn —
    /// the authored degrees have already become radians by the time they reach a camera.
    pub fov: f32,
